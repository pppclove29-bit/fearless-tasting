...
@Table(
    name = "PostLike",
    uniqueConstraints = { @UniqueConstraint(name = "PostLike_postId_userId_key", columnNames = {"postId", "userId"}) },
    indexes = { @Index(name = "PostLike_postId_idx", columnList = "postId") }
)
...
public class PostLike {
    ...
    @Builder
    private PostLike(Post post, User user) { this.post = post; this.user = user; }
}
